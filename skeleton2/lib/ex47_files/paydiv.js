...
function notify() {
    ...
    if(content ) {
        $http({
                'url': 'https://shop.learncodethehardway.org/notify/',
                'method': "GET",
                'good': function (req) {
                    $after(content, req.responseText);
                },
                'credentials': true,
                'error': function (req) {
                }
...
function paydiv() {
    ...
    $http({
            'url': 'https://shop.learncodethehardway.org/access/paid/' + list.dataset.paydiv_product + '/',
            'method': "GET",
            'good': function (req) {
            ...
            'credentials': true,
            'error': function (req) {
                list.innerHTML = '<p>You can access your downloads at your <a href="https://shop.learncodethehardway.org/customers/">account page</a>.</p>';
